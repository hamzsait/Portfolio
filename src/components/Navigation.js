...
function addLineBlue(){
    document.getElementById("lineblue").classList.add('setBlue')
}

function addLineGreen(){
    document.getElementById("linegreen").classList.add('setGreen')
}
            ...
            <div>
                <Navbar id="navbar" bg="light" variant="dark">
                    <Nav className="mr-auto">
                        ...
                        <Nav.Link onMouseOver={() => addLineBlue()} className = 'lineblue' id = 'blueText' href="/projects">Projects</Nav.Link>
                        <h1 id = 'linegreen' onMouseOver={() => alertgreen()} className ='nav-link linegreen'>|</h1>
                        <Nav.Link onMouseOver={() => addLineGreen()} className = 'linegreen' id = 'greenText' href="/about">About</Nav.Link>
                        <h1 id = 'linered' onMouseOver={() => alertred()} className ='nav-link linered'>|</h1>
                        <Nav.Link onMouseOver={() => addLineRed()} id = 'redText' className = 'linered' href="/contact">Contact</Nav.Link>
                    </Nav>
